# elasticsearch get-nodes-info

Get elastic search cluster nodes information
...
`elasticsearch get-nodes-info [--site  <site>] [--cluster  <cluster>] [--nodes  <nodes>]`
...
Input: 
```
! elasticsearch get-nodes-info --site "localhost" --cluster "elastic-1" --nodes "beehyv-H81M-S"
```
Output: 
```
{
  ...
  "nodes": {
    "qQmwEJbkTdW-ixce6PgTFQ": {
      ...
      "settings": {
        ...
        "node": {
          "attr": {
            ...
            "ml": {
              "max_jvm_size": "1073741824",
              "machine_memory": "16714604544",
              "max_open_jobs": "512"
            }
          },
          "name": "beehyv-H81M-S",
      ...
      "jvm": {
        ...
        "start_time_in_millis": 1633259576295,
        "mem": {
        ...
        "input_arguments": [
          ...
          "-Xmx1g",
          "-XX:+UseG1GC",
          "-Djava.io.tmpdir=/tmp/elasticsearch-10743714864597630075",
      ...
      "modules": [
        ...
        },
        {
          ...
          "extended_plugins": ["x-pack-core", "lang-painless"],
          "has_native_controller": false,
          "licensed": false,
          "type": "isolated"
        },
        ...
        },
        {
          ...
          "extended_plugins": ["x-pack-ql", "lang-painless"],
          "has_native_controller": false,
          "licensed": false,
          "type": "isolated"
        },
        ...
        },
        {
          ...
          "extended_plugins": ["x-pack-autoscaling", "lang-painless"],
      ...
      "aggregations": {
        ...
        "diversified_sampler": {
          "types": ["boolean", "date", "keyword", "numeric"]
        },
        "extended_stats": {
          "types": ["boolean", "date", "numeric"]
        },
        ...
        "histogram": {
          "types": ["boolean", "date", "histogram", "numeric", "range"]
        },
        "ip_range": {
          "types": ["ip"]
        },
        ...
        "percentile_ranks": {
          "types": ["boolean", "date", "histogram", "numeric"]
        },
        "percentiles": {
          "types": ["boolean", "date", "histogram", "numeric"]
        },
        ...
        "rare_terms": {
          "types": ["boolean", "date", "ip", "keyword", "numeric"]
        },
        "rate": {
          "types": ["histogram", "numeric"]
        },
