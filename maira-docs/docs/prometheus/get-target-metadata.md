...
`prometheus get-target-metadata [--site  <site>] [--cluster  <cluster>] [--label  <label>] [--label_value  <label_value>] [--metric  <metric>] [--limit  <limit>]`
...
&nbsp;&nbsp;&nbsp;&nbsp; Name of Label selector used to match targets  

&nbsp;&nbsp;&nbsp;&nbsp; Example:  `--label  "job, instance"`
...
&nbsp;&nbsp;&nbsp;&nbsp; Value of Label selector used to match targets  

&nbsp;&nbsp;&nbsp;&nbsp; Example:  `--label_value  "prometheus, 127.0.0.1:9000"`
...
&nbsp;&nbsp;&nbsp;&nbsp; A metric name to retrieve metadata for  
...
Input: 
```
! prometheus get-target-metadata --site "localhost" --label "job" --label_value "prometheus"
```
Output: 
```
{
  ...
  "data": [
    ...
    },
    {
      ...
      "metric": "prometheus_tsdb_out_of_order_exemplars_total",
      "type": "counter",
    ...
    },
    {
      ...
      "metric": "prometheus_target_scrape_pool_exceeded_target_limit_total",
      "type": "counter",
    ...
    },
    {
      ...
      "metric": "prometheus_tsdb_data_replay_duration_seconds",
      "type": "gauge",
